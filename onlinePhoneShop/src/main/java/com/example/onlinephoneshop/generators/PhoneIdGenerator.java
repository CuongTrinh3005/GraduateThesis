...
public class PhoneIdGenerator implements IdentifierGenerator, Configurable {
    private String prefix;
    private final int startIndexOfNum = 10, lengthOfId = 14;
    ...
    public Serializable generate(
        ...
        if (existDatePrefixList.size() > 0) {
            max = ids.map(o -> o.toString().substring(startIndexOfNum, lengthOfId))
